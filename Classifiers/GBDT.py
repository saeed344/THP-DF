...
params = {'loss': 'deviance', 'learning_rate': 0.1,
          'n_estimators': 30, 'subsample': 1.0, 'criterion': 'friedman_mse',
          'min_samples_split': 2, 'min_samples_leaf': 1, 'min_weight_fraction_leaf': 0.0,
          'max_depth': 5, 'min_impurity_split': None,
          'max_features': 'sqrt', 'verbose': 1, 'max_leaf_nodes': None,
...
filename="GB-trained model"
joblib.dump(cv_clf ,filename)
